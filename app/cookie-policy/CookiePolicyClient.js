...
import cookieStyle from "./cookie-policy.module.scss";
    ...
    <main className={Style.mainPriv}>
      <section className={Style.content_section}>
        ...
        <div className={Style.layout}>
          <aside className={`${Style.sidebar} ${cookieStyle.sidebarPad}`} data-animation="fade-up">
            <button className={Style.tab_pill}>Cookie Policy</button>
          </aside>

          <div className={`${Style.content_panel} ${cookieStyle.contentPad}`}>
