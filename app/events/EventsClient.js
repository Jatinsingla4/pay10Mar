    ...
    <main>
      ...
      >
        ...
        <div className={Style.bannerContent}>
          <h1 data-animation="opacity-up" dangerouslySetInnerHTML={{ __html: sanitizeHtml(pageData?.page_title) }} />
          <p data-animation="opacity-up" data-anim-delay="200" dangerouslySetInnerHTML={{ __html: sanitizeHtml(pageData?.page_subtitle) }} />
        </div>
      </section>
