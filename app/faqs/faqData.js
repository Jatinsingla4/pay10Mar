...
const faqData = [
  ...
  {
    tabName: "FAQ Send Abroad",
    faqs: [
      {
        question: "1. What is Send Abroad in Pay10?",
        answer: "Send Abroad allows eligible Pay10 users to send money from their Pay10 account to a beneficiary’s bank account, wallet or other supported local payment account in supported countries through the Pay10 UAE App."
      },
      {
      ...
      },
      {
        ...
        answer: "The required details may vary by country, but generally include the recipient’s full name (as per bank records), bank account details, and contact number. When you start a transfer, Pay10 UAE App will guide you through the required information."
      },
      {
